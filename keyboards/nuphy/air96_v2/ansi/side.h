...
// 		breathe data table
//----------------------------------------------------------------
const uint8_t react_data_tab[REACT_TAB_LEN]=
{
	0,      255,	248,	241,	234,	227,	220,	213,	206,
	200,	194,	188,	182,	176,	170,	164,	158,
	152,	146,	140,	134,	129,	124,	119,	114,
	109,	104,	99,		94,		89,		85,		81,		77,
	73,		69,		65,		61,		57,		53,		49,		45,
...
// TAIKO PATTERN ANIMATION FOR REACT EFFECT
const uint16_t react_taiko_col[REACT_TAB_LEN][4]=
{
    {0xff, 0x04, 0x00},
    {0x00, 0x2a, 0xff},
};
...
// WHITE => RED PATTERN ANIMATION FOR REACT EFFECT
const uint16_t react_tr0_col[REACT_TAB_LEN][3]=
{
	{0xff, 0xff, 0xff},
    {0xff, 0xff, 0xff},
    {0xff, 0xff, 0xff},
...
// RAINBOW => RAINBOW PATTERN ANIMATION FOR REACT EFFECT
const uint16_t react_tr1_col[REACT_TAB_LEN][3]=
{
	{0xff, 0x00, 0x00},
    {0xff, 0x11, 0x00},
    {0xff, 0x22, 0x00},
...
// EVA01 PATTERN ANIMATION FOR REACT EFFECT
const uint16_t react_tr2_col[REACT_TAB_LEN][3]=
{
	{0x77, 0x00, 0xff},
    {0x66, 0x00, 0xdd},
    {0x55, 0x00, 0xbb},
...
// NOTHING PHONE GLYPH PATTERN ANIMATION FOR REACT EFFECT
const uint16_t react_tr3_col[REACT_TAB_LEN][3]=
{
	{0xff, 0xff, 0xff},
    {0xdd, 0xdd, 0xdd},
    {0xbb, 0xbb, 0xbb},
