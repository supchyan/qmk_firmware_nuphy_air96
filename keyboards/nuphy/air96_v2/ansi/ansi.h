...
bool drum_left_rim;
#define DRUM_LEFT_RIM       drum_left_rim

bool drum_left_centre;
#define DRUM_LEFT_CENTRE    drum_left_centre

bool drum_right_centre;
#define DRUM_RIGHT_CENTRE   drum_right_centre

bool drum_right_rim;
#define DRUM_RIGHT_RIM      drum_right_rim
